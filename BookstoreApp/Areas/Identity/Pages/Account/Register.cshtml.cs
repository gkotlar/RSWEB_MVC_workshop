...
namespace BookstoreApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private BookstoreAppUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<BookstoreAppUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(BookstoreAppUser)}'. " +
                    $"Ensure that '{nameof(BookstoreAppUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<BookstoreAppUser> GetEmailStore()
        {
