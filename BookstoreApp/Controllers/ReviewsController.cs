...
namespace BookstoreApp.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        {
            var reviewContext = _context.Review.Include(r => r.Book);
        ...
        {
            ViewData["BookId"] = new SelectList(_context.Set<Book>(), "Id", "Publisher");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,BookId,AppUser,Comment,Rating")] Review review)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Set<Book>(), "Id", "Publisher", review.BookId);
            return View(review);
        }
